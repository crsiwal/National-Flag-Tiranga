<?php
$title = $name . " ने 75वें स्वतंत्रता दिवस के अवसर पर आपको तिरंगा भेजा। आप भी इसे अपने पास न रखें इसे अपने सभी दोस्तों को भेजें।";
$summery = "आजादी का अमृत महोत्सव एक 75-सप्ताह का भव्य उत्सव है जिसे माननीय प्रधान मंत्री श्री नरेंद्र मोदी द्वारा स्वतंत्रता के 75 वर्ष के अवसर पर शुरू किया गया था।";
$alt = "आजादी का अमृत महोत्सव, भारत के स्वतंत्रता दिवस का 75 वां वर्ष";
?>
<!DOCTYPE html>
...
<head>
  ...
  <meta property="og:image" content="<?= base_url("images/75hindi.png"); ?>" />
  <meta property="og:image:secure_url" content="<?= base_url("images/75hindi.png"); ?>" />
  ...
  <meta property="twitter:image" content="<?= base_url("images/75hindi.png"); ?>" />
...
<body>
  ...
  <div class="container pb-5">
    <div class="text-center mt-4">
      <img style="max-height: 100px;" class="img-fluid" src="<?= base_url("images/75hindi.png"); ?>" alt="">
      <img class="img-fluid" src="<?= base_url("images/wish.png"); ?>" alt="">
      <p class="imgtext">हमें भारतीय होने पर गर्व है।!!!</p>
    </div>

    <p class="text1"><?= $name; ?></p>
    <p class="text2">ने आपको भेजा है</p>
    ...
    <p class="text3">राष्ट्रीय ध्वज, तिरंगा !!!</p>
    <div class="text-center mt-4 fs-6">
      आपसे पहले <img style="height: 20px;" src="https://hitwebcounter.com/counter/counter.php?page=8023709&style=0025&nbdigits=1&type=page&initCount=0" />
      भारतीय लोगों ने अपने दोस्तों और परिवार को <span class="fs-4">राष्ट्रीय ध्वज</span> भेजा है। आप भी जल्दी कीजिए, क्योंकि इसे <span class="fs-3">15 अगस्त</span> से पहले भेजना है।
    </div>
    ...
    <div class="text-center mt-4">
      <button id="send" class="btn fs-5 flagcolor rounded-pill px-5" type="button" data-bs-toggle="modal" data-bs-target="#share">
        ...
        </svg>अपने दोस्तों को राष्ट्रीय ध्वज भेजें</button>
    </div>
    <div class="text-center pt-5">
      <a href="<?= base_url($name); ?>" class="btn btn-link">Click here for go to Tiranga, English Website</a>
    </div>
  </div>
  <footer>
    <!-- The Modal -->
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="mt-4 text-center">
              <div class="fs-1">अपने दोस्तों को <span class="fblike">राष्ट्रीय ध्वज</span> भेजें</div>
            </div>
            <img class="img-fluid" src="<?= base_url("images/wish.png"); ?>" alt="" />
            <div class="mt-4 text-center">
              <div class="fblike fs-4 text-start">
                <span class="txt4">Step 1: </span>
                <span class="txt1">लाइक</span>
                <span class="txt3">बटन पर क्लिक करें</span>
              </div>
              <div class="ps-0">
            ...
            <div class="d-grid px-1">
              <div class="mt-4 text-center">
                <div class="fblike fs-4 text-start">
                  ...
                  <span class="txt1">निचे अपना नाम</span>
                  <span class="txt3">लिखे</span>
                </div>
                ...
                <div class="fblike fs-4 my-3 text-start">
                  ...
                  <span class="txt1">अपने</span>
                  <span class="txt3">दोस्तों को शेयर करें</span>
                </div>
                <button id="wpshare" class="btn flagcolor btnshare" data-text='Someone has sent a Jai Hind Flag to you. Click on below link to view the message. https://flag.share.ind.in' data-original-title="Share to WhatsApp" rel="tooltip" data-placement="left" data-action="share/whatsapp/share">
